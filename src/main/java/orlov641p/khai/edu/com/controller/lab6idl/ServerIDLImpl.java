...
public class ServerIDLImpl extends ServerIDLPOA {
    ...
    public String sendClientMessage(String operation) {
        ...
        StringBuilder response = new StringBuilder("ClientIDL sent " + urlParts[0] + " operation\n");
        switch (urlParts[0]) {
            case "FIND_ALL" : {
    ...
    public String sendOrderMessage(String operation) {
        String[] urlParts = operation.split("/");
        StringBuilder response = new StringBuilder("OrderIDL sent " + urlParts[0] + " operation\n");
        switch (urlParts[0]) {
            case "FIND_ALL" : {
    ...
    public String sendFlightMessage(String operation) {
        String[] urlParts = operation.split("/");
        StringBuilder response = new StringBuilder("FlightIDL sent " + urlParts[0] + " operation\n");
        switch (urlParts[0]) {
            case "FIND_ALL" : {
    ...
    public String sendTicketMessage(String operation) {
        String[] urlParts = operation.split("/");
        StringBuilder response = new StringBuilder("TicketIDL sent " + urlParts[0] + " operation\n");
        switch (urlParts[0]) {
            case "FIND_ALL" : {
